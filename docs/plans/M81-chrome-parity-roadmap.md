...
- [x] F1. ESM 模块 eval 性能 ✓（react 34x / nuxt 24x 提速，批 30 网络层并行化）
- [x] F2. 大页面内存 profile ✓（28MB for 3730 DOM nodes，vs Chrome 279MB = 1/10）
- [x] F3. 崩溃防护审计 ✓（spawn_blocking + catch_unwind 已在 navigate/click/keyboard 路径）
